...
**Early Development:** cudup is currently in early development, do not use it yet
...
`cudup` is a command-line tool that simplifies managing multiple CUDA toolkit and cuDNN installations on your system.
...
Documentation:  **[zocrit.github.io/cudup](https://zocrit.github.io/cudup/)**
